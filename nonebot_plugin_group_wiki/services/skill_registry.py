...
WIKI_SKILLS: tuple[WikiSkill, ...] = (
    ...
    WikiSkill(
        ...
        keywords=("布键", "映射", "按键", "鼠标", "摇杆", "视角", "配置文件", "开镜", "背包", "载具", "手势", "蓄力"),
    ),
    WikiSkill(
    ...
    WikiSkill(
        ...
        keywords=("卡顿", "延迟", "连不上", "没反应", "不生效", "管理员权限", "回报率", "异步", "触摸点", "反作弊"),
    ),
)
...
def is_qinex_related(text: str) -> bool:
    normalized = text.strip().lower()
    product_markers = ("qinex", "映射", "压枪", "连点", "投屏", "screenhub", "qinescreen", "p4", "s3", "adb", "键鼠")
